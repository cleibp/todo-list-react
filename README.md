...
## ✍️ Descrição
Exemplificação de TODO LIST usando biblioteca react
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/todo-list-react.git
    ```
1. Download:
    ### Download Manual
...
[Publicação em Codepen](https://codepen.io/cleibp/pen/zYyprdQ) 
